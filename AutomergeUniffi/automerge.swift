...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_automerge_6c66_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_automerge_6c66_rustbuffer_free(self, $0) }
    }
}
...
public protocol DocProtocol {
    ...
    func `spliceText`(`obj`: ObjId, `start`: UInt64, `delete`: UInt64, `chars`: String) throws
    func `splice`(`obj`: ObjId, `start`: UInt64, `delete`: UInt64, `values`: [ScalarValue]) throws
...
public class Doc: DocProtocol {
    ...
    automerge_6c66_Doc_new($0)
})
    }

    deinit {
        try! rustCall { ffi_automerge_6c66_Doc_object_free(pointer, $0) }
    }

    
    public static func `newWithActor`(`actor`: ActorId)  -> Doc {
        return Doc(unsafeFromRawPointer: try!
    
    rustCall() {
    
    automerge_6c66_Doc_new_with_actor(
    ...
    rustCallWithError(FfiConverterTypeLoadError.self) {
    
    automerge_6c66_Doc_load(
    ...
    automerge_6c66_Doc_actor_id(self.pointer, $0
    )
}
        )
    }
    ...
    automerge_6c66_Doc_set_actor(self.pointer, 
        FfiConverterTypeActorId.lower(`actor`), $0
    )
}
    }
    ...
    automerge_6c66_Doc_fork(self.pointer, $0
    )
}
        )
    }
    public func `forkAt`(`heads`: [ChangeHash]) throws -> Doc {
        return try FfiConverterTypeDoc.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_fork_at(self.pointer, 
    ...
    public func `putInMap`(`obj`: ObjId, `key`: String, `value`: ScalarValue) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_put_in_map(self.pointer, 
    ...
    public func `putObjectInMap`(`obj`: ObjId, `key`: String, `objType`: ObjType) throws -> ObjId {
        return try FfiConverterTypeObjId.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_put_object_in_map(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterString.lower(`key`), 
    ...
    public func `putInList`(`obj`: ObjId, `index`: UInt64, `value`: ScalarValue) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_put_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
    ...
    public func `putObjectInList`(`obj`: ObjId, `index`: UInt64, `objType`: ObjType) throws -> ObjId {
        return try FfiConverterTypeObjId.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_put_object_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`index`), 
        FfiConverterTypeObjType.lower(`objType`), $0
    )
    ...
    public func `insertInList`(`obj`: ObjId, `index`: UInt64, `value`: ScalarValue) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_insert_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`index`), 
        FfiConverterTypeScalarValue.lower(`value`), $0
    )
    ...
    public func `insertObjectInList`(`obj`: ObjId, `index`: UInt64, `objType`: ObjType) throws -> ObjId {
        return try FfiConverterTypeObjId.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_insert_object_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`index`), 
        FfiConverterTypeObjType.lower(`objType`), $0
    )
    ...
    public func `spliceText`(`obj`: ObjId, `start`: UInt64, `delete`: UInt64, `chars`: String) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_splice_text(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
    ...
    public func `splice`(`obj`: ObjId, `start`: UInt64, `delete`: UInt64, `values`: [ScalarValue]) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_splice(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`start`), 
        FfiConverterUInt64.lower(`delete`), 
    ...
    public func `deleteInMap`(`obj`: ObjId, `key`: String) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_delete_in_map(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
    ...
    public func `deleteInList`(`obj`: ObjId, `index`: UInt64) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_delete_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
    ...
    public func `incrementInMap`(`obj`: ObjId, `key`: String, `by`: Int64) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_increment_in_map(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterString.lower(`key`), 
    ...
    public func `incrementInList`(`obj`: ObjId, `index`: UInt64, `by`: Int64) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_increment_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`index`), 
        FfiConverterInt64.lower(`by`), $0
    )
    ...
    public func `getInMap`(`obj`: ObjId, `key`: String) throws -> Value? {
        return try FfiConverterOptionTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_get_in_map(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterString.lower(`key`), $0
    )
}
    ...
    public func `getInList`(`obj`: ObjId, `index`: UInt64) throws -> Value? {
        return try FfiConverterOptionTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_get_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`index`), $0
    )
}
    ...
    public func `getAtInMap`(`obj`: ObjId, `key`: String, `heads`: [ChangeHash]) throws -> Value? {
        return try FfiConverterOptionTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_get_at_in_map(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterString.lower(`key`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
    ...
    public func `getAtInList`(`obj`: ObjId, `index`: UInt64, `heads`: [ChangeHash]) throws -> Value? {
        return try FfiConverterOptionTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_get_at_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`index`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
    ...
    public func `getAllInMap`(`obj`: ObjId, `key`: String) throws -> [Value] {
        return try FfiConverterSequenceTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_get_all_in_map(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterString.lower(`key`), $0
    )
}
    ...
    public func `getAllInList`(`obj`: ObjId, `index`: UInt64) throws -> [Value] {
        return try FfiConverterSequenceTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_get_all_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`index`), $0
    )
}
    ...
    public func `getAllAtInMap`(`obj`: ObjId, `key`: String, `heads`: [ChangeHash]) throws -> [Value] {
        return try FfiConverterSequenceTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_get_all_at_in_map(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterString.lower(`key`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
    ...
    public func `getAllAtInList`(`obj`: ObjId, `index`: UInt64, `heads`: [ChangeHash]) throws -> [Value] {
        return try FfiConverterSequenceTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_get_all_at_in_list(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterUInt64.lower(`index`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
    ...
    public func `text`(`obj`: ObjId) throws -> String {
        return try FfiConverterString.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_text(self.pointer, 
    ...
    public func `textAt`(`obj`: ObjId, `heads`: [ChangeHash]) throws -> String {
        return try FfiConverterString.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_text_at(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
}
    ...
    automerge_6c66_Doc_map_keys(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), $0
    )
}
        )
    ...
    automerge_6c66_Doc_map_keys_at(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
}
    ...
    public func `mapEntries`(`obj`: ObjId) throws -> [KeyValue] {
        return try FfiConverterSequenceTypeKeyValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_map_entries(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), $0
    )
}
        )
    ...
    public func `mapEntriesAt`(`obj`: ObjId, `heads`: [ChangeHash]) throws -> [KeyValue] {
        return try FfiConverterSequenceTypeKeyValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_map_entries_at(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
}
    ...
    public func `values`(`obj`: ObjId) throws -> [Value] {
        return try FfiConverterSequenceTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_values(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), $0
    )
}
        )
    ...
    public func `valuesAt`(`obj`: ObjId, `heads`: [ChangeHash]) throws -> [Value] {
        return try FfiConverterSequenceTypeValue.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_values_at(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
}
    ...
    automerge_6c66_Doc_length(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), $0
    )
}
        )
    ...
    automerge_6c66_Doc_length_at(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
}
    ...
    public func `path`(`obj`: ObjId) throws -> [PathElement] {
        return try FfiConverterSequenceTypePathElement.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_path(self.pointer, 
        FfiConverterTypeObjId.lower(`obj`), $0
    )
}
        )
    ...
    automerge_6c66_Doc_heads(self.pointer, $0
    )
}
        )
    }
    ...
    automerge_6c66_Doc_save(self.pointer, $0
    )
}
        )
    }
    public func `merge`(`other`: Doc) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_merge(self.pointer, 
    ...
    public func `mergeWithPatches`(`other`: Doc) throws -> [Patch] {
        return try FfiConverterSequenceTypePatch.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_merge_with_patches(self.pointer, 
        FfiConverterTypeDoc.lower(`other`), $0
    )
}
        )
    ...
    automerge_6c66_Doc_generate_sync_message(self.pointer, 
    ...
    public func `receiveSyncMessage`(`state`: SyncState, `msg`: [UInt8]) throws {
        try
    rustCallWithError(FfiConverterTypeReceiveSyncError.self) {
    automerge_6c66_Doc_receive_sync_message(self.pointer, 
    ...
    public func `receiveSyncMessageWithPatches`(`state`: SyncState, `msg`: [UInt8]) throws -> [Patch] {
        return try FfiConverterSequenceTypePatch.lift(
            try
    rustCallWithError(FfiConverterTypeReceiveSyncError.self) {
    automerge_6c66_Doc_receive_sync_message_with_patches(self.pointer, 
        FfiConverterTypeSyncState.lower(`state`), 
        FfiConverterSequenceUInt8.lower(`msg`), $0
    )
}
    ...
    automerge_6c66_Doc_encode_new_changes(self.pointer, $0
    )
}
        )
    }
    public func `encodeChangesSince`(`heads`: [ChangeHash]) throws -> [UInt8] {
        return try FfiConverterSequenceUInt8.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_encode_changes_since(self.pointer, 
        FfiConverterSequenceTypeChangeHash.lower(`heads`), $0
    )
}
        )
    ...
    public func `applyEncodedChanges`(`changes`: [UInt8]) throws {
        try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_apply_encoded_changes(self.pointer, 
    ...
    public func `applyEncodedChangesWithPatches`(`changes`: [UInt8]) throws -> [Patch] {
        return try FfiConverterSequenceTypePatch.lift(
            try
    rustCallWithError(FfiConverterTypeDocError.self) {
    automerge_6c66_Doc_apply_encoded_changes_with_patches(self.pointer, 
        FfiConverterSequenceUInt8.lower(`changes`), $0
    )
}
        )
...
public class SyncState: SyncStateProtocol {
    ...
    automerge_6c66_SyncState_new($0)
})
    }

    deinit {
        try! rustCall { ffi_automerge_6c66_SyncState_object_free(pointer, $0) }
    }

    
    public static func `decode`(`bytes`: [UInt8]) throws -> SyncState {
        return SyncState(unsafeFromRawPointer: try
    
    rustCallWithError(FfiConverterTypeDecodeSyncStateError.self) {
    
    automerge_6c66_SyncState_decode(
        FfiConverterSequenceUInt8.lower(`bytes`), $0)
})
    }
    ...
    automerge_6c66_SyncState_encode(self.pointer, $0
    )
}
        )
    }
    ...
    automerge_6c66_SyncState_reset(self.pointer, $0
    )
}
    }
    ...
    automerge_6c66_SyncState_their_heads(self.pointer, $0
    )
}
        )
    }
...
public enum PatchAction {
    ...
    case `spliceText`(`obj`: ObjId, `index`: UInt64, `value`: String)
...
public struct FfiConverterTypePatchAction: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PatchAction {
        ...
        case 5: return .`deleteMap`(
            `obj`: try FfiConverterTypeObjId.read(from: &buf), 
            `key`: try FfiConverterString.read(from: &buf)
        )
        
        case 6: return .`deleteSeq`(
            `obj`: try FfiConverterTypeObjId.read(from: &buf), 
            `index`: try FfiConverterUInt64.read(from: &buf), 
 ...
 */
public enum AutomergeLifecycle {
    /**
